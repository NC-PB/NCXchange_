...
/// <summary>
/// The codes of every part of the DiagnosticCodes class of Ncx.Cli follow D98, so that parts written side by side
/// cannot clash.
/// </summary>
public sealed class DiagnosticCodesTests
{
    // A code is an area prefix and three digits; Ncx.Cli holds the area CLI (D98, implementation 00-method 4).
    [Fact]
    public void DiagnosticCodes_EveryCode_IsCliWithThreeDigits()
    {
        ...
        {
            Assert.Matches("^CLI[0-9]{3}$", Code(field));
        }
    }
