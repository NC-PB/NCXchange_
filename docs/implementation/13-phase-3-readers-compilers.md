...
- `FanucFrames` (`G54`.., `G54.1 P`, `G52` with `SHIFT=RESET`, `G53`, `G28`/`G30` as `HOME` with `POINT`, `G50`/`G92` as `SETPOS` or `RPM_MAX`, `G68`/`G69`, `G51.1`/`G50.1`, `G68.2`/`G53.1` as `TILT` with `MOVE`, `G68.1` as `TILT_AXIS`, `G43.4`/`G43.5` as `TCPM` and vectors, `G12.1`/`G7.1`, `G5.1 Q0` as `TOLERANCE=OFF`, `G5.1 Q1` kept `RAW` (controller-mapping 1)).
